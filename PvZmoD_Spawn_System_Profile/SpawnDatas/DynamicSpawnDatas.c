...
//ref TIntArray data_CountrySide =	{ 1,		2,			2,			1,			1,			100,		1,				0,					1 };			// Test	/ Debug	
ref TIntArray data_CountrySide =	{ 1,		10,			15,			2,			4,			100,		3,				30,					1 };			// 1 DEFAULT (Countryside)
ref TIntArray data_SmallTwon =		{ 10,		10,			15,			2,			5,			100,		3,				30,					10 };			// 10 SmallTwon
ref TIntArray data_AverageTown =	{ 20,		10,			15,			3,			7,			100,		5,				30,					20 };			// 20 AverageTown
ref TIntArray data_BigTown =		{ 30,		10,			15,			5,			9,			100,		10,				30,					30 };			// 30 BigTown
...
ref TIntArray data_Prison =			{ 71,		5,			7,			3,			5,			50,			3,				30,					71 };			// 71 Prison
...
ref TIntArray data_Config90 =		{ 90,		0,			0,			0,			0,			0,			0,				0,					0 };			// 
...
ref TIntArray data_Config98 =		{ 1,		2,			2,			1,			1,			100,		1,				0,					1 };			// Test	/ Debug	(can be modify if you need)
ref TIntArray data_Config99 =		{ 1,		2,			2,			1,			1,			10,			1,				0,					1 };			// Test	/ Debug	(can be modify if you need)

///  							NUMCONFIG	TIMEmini     TIMEmaxi	NBRmini		NBRmaxi		DISTANCE	AREA RADIUS 	Lateral SHIFT 	numChooseZombiesCategorie  

// //////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////

/// (DISTANCE + Lateral DECAL + AREA SIZE) should not exceed the "Z Despawn distance" (value of "01" line) of the RealTimeTweak.json file
/// or some Z could disappear just after they spawned
...
/// DISTANCE	  : Distance to which the group spawn
